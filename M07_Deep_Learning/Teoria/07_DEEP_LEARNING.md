...
- Playground (PyTorch + Streamlit): entrenar una MLP en vivo (XOR) + frontera de decisión:
  - `streamlit run M07_deep_learning/pytorch_training_playground_app.py`
...
- Evaluación (rúbrica): [Herramientas_Estudio/RUBRICA_v1.md](../Herramientas_Estudio/RUBRICA_v1.md) (scope `M07` en `rubrica.csv`; cierre Semana 20)
...
| **Obligatorio** | `Herramientas_Estudio/DRYRUN_BACKPROPAGATION.md` | Justo antes de tu primera implementación completa de Backprop | Hacer “dry-run” y detectar errores de gradiente antes del código |
| **Obligatorio** | `Herramientas_Estudio/EXAMEN_ADMISION_SIMULADO.md` | Después de que tu MLP resuelva XOR y antes de cerrar el módulo | Validación tipo examen (sin IDE/internet) |
...
| 20 | **PyTorch para CNNs + Sequence Modeling (Light)** | `M08_Proyecto_Integrador/Notebooks/train_cnn_pytorch.py` + `M08_Proyecto_Integrador/Notebooks/simple_rnn_forward.py` |
...
- **Ejecutable:**
  - `python3 M08_Proyecto_Integrador/Notebooks/simple_rnn_forward.py`
- **Qué debes entender:**
...
- **v4.0 (Semana 18):** antes de programar, completar `Herramientas_Estudio/DRYRUN_BACKPROPAGATION.md`.
...
- **Interleaving:** alterna ejercicios de backprop con ejercicios de shapes (recomendado: `Herramientas_Estudio/DRILL_DIMENSIONES_NUMPY.md`).
...
- [RECURSOS.md](RECURSOS.md)
- `Herramientas_Estudio/DRYRUN_BACKPROPAGATION.md`
- `Herramientas_Estudio/EXAMEN_ADMISION_SIMULADO.md`
...
- [ ] Entrené una CNN equivalente con PyTorch usando `M08_Proyecto_Integrador/Notebooks/train_cnn_pytorch.py`

### Sequence Modeling (Light)
- [ ] Ejecuté `M08_Proyecto_Integrador/Notebooks/simple_rnn_forward.py` y verifiqué shapes `(batch,time,features)`
...
> Rigor matemático formal, contexto histórico y conexiones teóricas profundas para Deep Learning.

---

## A.1 Las Tres Olas del Deep Learning

**Primera ola (1943-1969): Cibernética**
- 1943: McCulloch & Pitts — Neurona artificial
- 1958: Rosenblatt — Perceptrón
- 1969: Minsky & Papert — *Perceptrons* (crítica)

**Segunda ola (1980-1995): Conexionismo**
- 1986: Rumelhart, Hinton, Williams — Backpropagation
- 1989: LeCun — ConvNets para dígitos
- 1997: Hochreiter & Schmidhuber — LSTM

**Tercera ola (2006-presente): Deep Learning**
- 2006: Hinton — Deep Belief Networks
- 2012: Krizhevsky — AlexNet (ImageNet)
...
### Enunciado (Cybenko, 1989)

Una red con **una capa oculta** y suficientes neuronas puede aproximar cualquier función continua en un dominio compacto.

**Pero:** "Suficientes" puede ser exponencialmente grande. Redes **profundas** son más eficientes.

---

## A.3 Backpropagation: Derivación Formal
...
## A.4 Funciones de Activación: Análisis

| Función | Derivada | Problema |
|---------|----------|----------|
| Sigmoid | $\sigma(1-\sigma)$ | Saturación, gradientes ~0 |
| Tanh | $1-\tanh^2$ | Saturación |
| ReLU | $\mathbb{1}_{z>0}$ | "Dying ReLU" |
| GELU | Aproximación suave | Preferida en Transformers |

---

## A.5 Regularización: Teoría

### Dropout (Srivastava, 2014)

**Interpretación Bayesiana:** Aproxima un ensemble de redes.

**Durante training:** $\tilde{a} = a \odot m / (1-p)$ donde $m \sim \text{Bernoulli}(1-p)$
...
**Beneficios:** Learning rates mayores, menos sensible a inicialización.

---

## A.6 CNNs: Propiedades Teóricas

### Equivarianza a Traslación

Si $T$ es traslación: $(T(f) * g) = T(f * g)$

### Parámetros vs Conexiones

Para imagen $224 \times 224$ con 64 filtros $3 \times 3$:
- **FC:** $224^2 \times 64 = 3.2M$ parámetros
- **Conv:** $3 \times 3 \times 64 = 576$ parámetros

---

## A.7 RNNs: Vanishing/Exploding Gradients

### Análisis

$$\frac{\partial h_T}{\partial h_1} = \prod_{t=1}^{T-1} W_{hh}^T \text{diag}(\sigma'(z_t))$$

- Eigenvalues < 1: **Vanishing**
- Eigenvalues > 1: **Exploding**

### LSTM: Solución

Cell state $C_t$ permite gradientes fluir sin multiplicación repetida.

---

## A.8 Optimización: Convergencia
...
## A.9 Conexiones con MS-AI Pathway

| Concepto | Curso | Aplicación |
|----------|-------|------------|
| MLPs/Backprop | DTSA 5511 | Fundamentos |
| CNNs | DTSA 5511 | Visión por computadora |
| RNNs/LSTM | DTSA 5511 | NLP, series temporales |
| Regularización | DTSA 5511 | Prevención de overfitting |
| Optimización | DTSA 5511 | Entrenamiento eficiente |

---

## A.10 Referencias Académicas

1. **Goodfellow, I., Bengio, Y., & Courville, A. (2016).** *Deep Learning*. MIT Press.
2. **He, K., et al. (2015).** "Deep Residual Learning." arXiv:1512.03385.
...
|----------|--------|-----------|
| [M06_Aprendizaje_No_Supervisado](../../M06_Aprendizaje_No_Supervisado/) | [README](../../README.md) | [M08_Proyecto_Integrador](../../M08_Proyecto_Integrador/) |
